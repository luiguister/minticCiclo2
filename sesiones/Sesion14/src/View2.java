...
class View2 extends JFrame{
    ...
    View2(Model2 model2) {
        ...
        //... Set up the logic
    	m_model2 = model2;
    	m_model2.setCodigo(INITIAL_VALUE2);
    	m_model2.setNombre(INITIAL_VALUE);
    	m_model2.setP_compra(INITIAL_VALUE2);
    	m_model2.setP_venta(INITIAL_VALUE2);
    	m_model2.setCant_b(INITIAL_VALUE2);
    	m_model2.setCant_min(INITIAL_VALUE2);
    	m_model2.setCant_max(INITIAL_VALUE2);
    ...
    void addCrearListener(ActionListener mal) {
    	jbnCrear.addActionListener(mal);
    }
    void addVerListener(ActionListener mal) {
